    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="addfile-form" enctype="multipart/form-data">
         ...
         <input class="form-control" type="text" placeholder="input file name" name="filename" id="" >
        </div>
        <div class="mb-3">
         <label for="formFileMultiple" class="form-label">You can only upload one file at a time</label>
         <input class="form-control" type="file" name="image" id="formFileMultiple" ><br>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#addexam-form').on('click', function(){
           var data = $("#addexam").serialize();   
            $.ajax({
