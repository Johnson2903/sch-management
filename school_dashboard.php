...
if(isset( $_SESSION["school_id"])){
                       ...
                       $sql_shool= "SELECT * FROM schools where school_id=$schoolId";
                      ...
                      // output data of each row
                       ...
                       $rows = $results->num_rows;$sql= "SELECT * FROM teacher where school_id='$schoolId'";
                       $results = $conn->query($sql);
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3"><?php echo $schoolname ?> Admin <sup></sup></div>
            </a>
...
<button type="button" class="d-none d-sm-inline-block btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-bs-whatever="@getbootstrap">
    <i class="fas fa-plus fa-sm text-white-50"></i>Add a New Teacher</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="addteacher-form">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="teacheremail" id="teacheremail" required />
          </div>
          <div class="mb-3">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="submitteacher" class="btn btn-primary">Add</button>
      </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="addsubject-form">
          <div class="mb-3">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" id="submitsubject" class="btn btn-primary">Add</button>
      </div>
      </form>
    </div>
  </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row_subject;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Number of class</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row_class;?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Techgiant</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
