...
$sql = "INSERT INTO `student` (`student_regno`, `exam_no`, `firstname`, `lastname`, `gender`, `dob`, `class`, `student_email`, `parent_email`, `student_phone`, `parent_phone`, `schoolID`, `address`,`parent_name`) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
